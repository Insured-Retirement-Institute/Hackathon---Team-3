...
@Component({
    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container" style="gap:12px">
            ...
            <a class="layout-topbar-logo" routerLink="/">
                <span style="position: relative;max-width: 100%;">
                    <img fetchpriority="high" decoding="async" width="650" height="35" src="https://proformex.com/wp-content/uploads/2024/01/Proformex-Logo-1.svg" alt="" title="Proformex Logo" class="" />
                </span>
            </a>
            <!-- <a href="https://proformex.com/"
...
export class AppTopbar implements AfterViewInit {
    items!: MenuItem[];
    @ViewChild(AppConfigurator) config!: AppConfigurator;

    constructor(public layoutService: LayoutService) {}
    ngAfterViewInit(): void {
        this.config.applyTheme('primary', 'noir');
    }
    ngOnInit(): void {}
